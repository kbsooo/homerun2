...
export async function GET(
  ...
  try {
    ...
    console.log(`Chat group API request headers:`, Object.fromEntries([...request.headers.entries()]));
    ...
    console.log(`Chat group API response headers: ${JSON.stringify(Object.fromEntries([...response.headers.entries()]))}`);
